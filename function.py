...
def print_ask(x): return f'[b orchid1][?] {x}[/]'
...
def create_hotkeys_win(log, labels, hotkeys) -> None:
    ...
    console.rule('[b green_yellow]Ready to use[/]')
...
def show_labels(log, labels) -> None:
    ...
    def column_add(x): return table.add_column(
